...
# SpaceGray Eighties -- Light
set -g status-style bg='#222222',fg='#bdbaae'
set -g window-status-style bg=colour7,fg=colour8
#set -g window-status-style bg=colour7,fg='#bdbaae'
set -g window-status-current-style bg=colour15,fg='#bdbaae',bold
